...
RUN cd home/ffmpeg ; ./configure --enable-gpl --enable-shared --disable-debug --enable-libx264 --enable-avresample ; make -j ; make install

RUN cd home/gpac ; ./configure ; make ; make install ; make install-lib
